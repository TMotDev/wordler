def filterWords(words: list[str], green_letters: dict[str, list[int]], yellow_letters: dict[str, list[int]], gray_letters: set[str]) -> set[str]:
    """
    ...
    -------
    set of str
        A set of words that satisfy all the given constraints.
